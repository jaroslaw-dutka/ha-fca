...
public class FcaLoginResponse : FcaResponse
{
    ...
    public FcaAuthData Data { get; set; }

    [JsonPropertyName("subscriptions")]
    public FcaSubscriptions Subscriptions { get; set; }

    [JsonPropertyName("preferences")]
    public Dictionary<string, FcaPreferences> Preferences { get; set; }

    [JsonPropertyName("emails")]
    public FcaEmails Emails { get; set; }
    ...
    public FcaProfile Profile { get; set; }
