...
public class FcaApiConfigProvider : IFcaApiConfigProvider
{
    private readonly FcaSettings _settings;
    private FcaApiConfig? _config;

    public FcaApiConfigProvider(ILogger<FcaApiConfigProvider> logger, IOptions<FcaSettings> options)
    {
    ...
    public FcaApiConfig Get() => _config ??= _settings switch
    {
        { Brand: FcaBrand.Ram } => new FcaApiConfig
        {
        ...
        { Brand: FcaBrand.Dodge } => new FcaApiConfig
        {
        ...
        { Brand: FcaBrand.Fiat, Region: FcaRegion.Europe } => new FcaApiConfig
        {
        ...
        { Brand: FcaBrand.Fiat, Region: FcaRegion.America } => new FcaApiConfig
        {
            LoginApiKey = "3_etlYkCXNEhz4_KJVYDqnK1CqxQjvJStJMawBohJU2ch3kp30b0QCJtLCzxJ93N-M",
            ApiKey = "OgNqp2eAv84oZvMrXPIzP8mR8a6d9bVm1aaH9LqU",
            AuthApiKey = "JWRYW7IYhW9v0RqDghQSx4UcRYRILNmc8zAuh5ys", // UNKNOWN
        ...
        { Brand: FcaBrand.Jeep, Region: FcaRegion.Europe } => new FcaApiConfig
        {
        ...
        { Brand: FcaBrand.Jeep, Region: FcaRegion.America } => new FcaApiConfig
        {
